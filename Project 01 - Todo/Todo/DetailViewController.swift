...
class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem?.accessibilityIdentifier = AccessibilityIdentifier.todoList

        doneButton.accessibilityIdentifier = AccessibilityIdentifier.doneButton
        todoTitleLabel.accessibilityIdentifier = AccessibilityIdentifier.title
        phoneButton.accessibilityIdentifier = AccessibilityIdentifier.phoneButton
        shoppingCartButton.accessibilityIdentifier = AccessibilityIdentifier.shoppingCartButton
        travelButton.accessibilityIdentifier = AccessibilityIdentifier.travelButton
        todoDatePicker.accessibilityIdentifier = AccessibilityIdentifier.todoDatePicker
