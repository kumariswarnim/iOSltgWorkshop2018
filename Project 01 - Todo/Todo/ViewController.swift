...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationItem.leftBarButtonItem?.accessibilityIdentifier = AccessibilityIdentifier.editList
        navigationItem.rightBarButtonItem?.accessibilityIdentifier = AccessibilityIdentifier.addTodoItem
